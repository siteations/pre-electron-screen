...
// changed to mediaelement.model.node.getDescription() from mediaelement.model.node.getDisplayTitle() by MK
				if ( okToProceed ) {
					var overlay = $('<div class="media_sidebar caption_font" style="min-height:initial;"><h2><a href="' + mediaelement.model.node.url + '">'+mediaelement.model.node.getDescription()+'</a></h2></div>').prependTo(mediaelement.model.element.parent());
