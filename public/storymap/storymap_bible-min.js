...
VCO.MenuBar = VCO.Class.extend({
	...
	_onButtonAboutSite: function(e) {
        this.fire("aboutsite", e)
    },
    ...
    _initLayout: function() {
		...
		this._el.button_aboutsite = VCO.Dom.create("span", "vco-menubar-button", this._el.container);
        VCO.DomEvent.addListener(this._el.button_aboutsite, "click", this._onButtonAboutSite, this);
        ...
        if (VCO.Browser.mobile) {
			...
			this._el.button_aboutsite.innerHTML = "<span class='vco-icon-about'></span>";
            this._el.button_collapse_toggle.innerHTML = "<span class='vco-icon-arrow-up'></span>";
			...
			this._el.button_aboutsite.innerHTML = VCO.Language.buttons.aboutsite + " <span class='vco-icon-about'></span>";
            this._el.button_collapse_toggle.innerHTML = VCO.Language.buttons.collapse_toggle + "<span class='vco-icon-arrow-up'></span>"
        }
...
VCO.MapMarker.Leaflet = VCO.MapMarker.extend({
    ...
    _createIcon: function(active) {
		...
		var newiconurl = active ? "./images/marker.png" :    this._custom_icon.url;			
        return new L.icon({
            iconUrl: newiconurl,
            iconSize: [20,20],
            iconAnchor: [10,10],
...
VCO.StoryMap = VCO.Class.extend({
    ...
    _initEvents: function() {
		...
		this._menubar.on("aboutsite", this._onAboutSite, this);
	...
	_onAboutSite: function(e) {
        this.current_slide = 37;
        this._map.goTo(this.current_slide);
        this._storyslider.goTo(this.current_slide);
        this.fire("change", {
            current_slide: this.current_slide
